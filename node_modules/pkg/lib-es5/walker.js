  ...
  (0, _createClass3.default)(Walker, [{
    ...
    value: function stepDetect(record, derivatives) {
      ...
      try {
        _detector2.default.detect(body, function (node, trying) {
          var rtd = record.tuple.dictionary;
          ...
          if (d) {
            if (d.mustExclude) return false;
            var level = rtd || d.mayExclude || trying ? 'debug' : 'warn';
          ...
          if (d) {
            ...
            var _level = rtd || trying ? 'debug' : 'warn'; // there is no 'mayExclude'
    ...
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(record, derivative) {
        var catcher, stage, newPackage, newTuple, newFile1, failure, isNear, mainNotFound, short, rtd, level;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 29:
                ...
                rtd = record.tuple.dictionary;
                level = rtd || derivative.mayExclude || mainNotFound ? 'debug' : 'warn';
