...
var need = exports.need = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
    ...
    var nodeRange, platform, arch, forceFetch, forceBuild, nodeVersions, nodeVersion, fetched, built, remote, fetchFailed;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            nodeRange = opts.nodeRange, platform = opts.platform, arch = opts.arch, forceFetch = opts.forceFetch, forceBuild = opts.forceBuild;
          ...
          case 12:
            ...
            nodeVersions = (0, _keys2.default)(_patches2.default).filter(function (nodeVersion) {
              return _semver2.default.satisfies(nodeVersion, nodeRange) || nodeRange === 'latest';
          ...
          case 17:
            ...
            _context.next = 25;
            return (0, _fsPromise.exists)(fetched);
          ...
          case 27:
            ...
            _context.next = 30;
            return (0, _fsPromise.exists)(built);
          ...
          case 33:
            ...
            _log.log.info('Fetching base binaries to:', _path2.default.dirname(fetched));
            _context.next = 37;
